...
function TableComponent({ data }: { data: TableRow[] }) {
  return (
    <div className="min-w-[563px] w-[563px] text-white flex flex-col gap-2">
      {/* Header */}
      <div className="bg-blackDDS w-[549px] px-[10px] rounded-[10px] flex items-center gap-2.5 text-[14px]">
      ...
      {/* Body */}
      <div className="flex flex-col gap-[2px] overflow-y-auto scrollbar-thin pr-2 h-[429px]">
        {data.map((row, index) => (
          <div
            key={index}
            className="bg-greyDDS px-[10px] rounded-[10px] flex items-center gap-2.5 text-[14px] w-[549px] min-h-[35px]"
          >
